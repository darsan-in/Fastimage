export default () => (
  <main className="flex-col px-10 mx-7 space-y-4 mt-10">
    ...
    <p>Effective date: 2024-08-01</p>
    <p>
      1. <b>Introduction</b>
    </p>
    <p>
      Welcome to <b> Fastimage</b>.
    </p>
    <p>
      <b>Fastimage</b> (“us”, “we”, or “our”) operates{" "}
      <b>fastimage.darsan.in</b> (hereinafter referred to as <b>“Service”</b>).
    </p>
    <p>
      Our Privacy Policy governs your visit to <b>fastimage.darsan.in</b>, and
    ...
    <p>
      <b>SERVICE</b> means the fastimage.darsan.in website operated by
      Fastimage.
    </p>
    <p>
    ...
    <p>
      Fastimage will take all the steps reasonably necessary to ensure that your
    ...
    <p>
      ...
      send your request(s) by email: <b>hello@darsan.in</b>.
    </p>
    <p>
