export default () => (
  <main className="flex-col px-10 mx-7 space-y-4 mt-10">
    <h1 className="font-bold text-3xl text-center">DISCLAIMER</h1>
    <p>Last updated: 2024-08-01</p>
    <p>
      <b>WEBSITE DISCLAIMER</b>
    </p>
    <p>
      The information provided by <b>Fastimage</b> (“Company”, “we”, “our”,
      “us”) on <b>fastimage.darsan.in</b> (the “Site”) is for general
    ...
    <p>
      ...
      links to websites and features. Such external links are not investigated,
    ...
    <p>
      ...
      in this site has been obtained from reliable sources, Fastimage is not
    ...
    <p>
      ...
      fastimage.darsan.in are the trademarks and logos of their respective
    ...
    <p>
      Should you have any feedback, comments, requests for technical support or
      other inquiries, please contact us by email: <b>hello@darsan.in</b>.
    </p>
  </main>
);
