export default () => (
  <main className="flex-col px-10 mx-7 space-y-4 mt-10">
    ...
    <p>
      Welcome to <b>Fastimage</b> (“Company”, “we”, “our”, “us”)!
    </p>
    <p>
      These Terms of Service (“Terms”, “Terms of Service”) govern your use of
      our website located at <b>fastimage.darsan.in</b> (together or
      individually “Service”) operated by <b>Fastimage</b>.
    </p>
    <p>
    ...
    <p>
      ...
      Fastimage and its licensors. Service is protected by copyright, trademark,
    ...
    <p>
      ...
      are not owned or controlled by Fastimage.
    </p>
    <p>
      Fastimage has no control over, and assumes no responsibility for the
